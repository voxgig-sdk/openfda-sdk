...
class OpenfdaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OpenfdaSDK/1.0)';
    ...
    public static function call(OpenfdaContext $ctx, string $fullurl, array $fetchdef): array
    {
