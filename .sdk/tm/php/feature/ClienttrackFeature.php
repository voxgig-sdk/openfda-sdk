...
// Openfda SDK clienttrack feature
...
class OpenfdaClienttrackFeature extends OpenfdaBaseFeature
{
    ...
    public function PostConstruct(OpenfdaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Openfda-SDK';
