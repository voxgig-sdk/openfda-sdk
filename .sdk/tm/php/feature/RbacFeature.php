...
class OpenfdaRbacFeature extends OpenfdaBaseFeature
{
    ...
    private function _required(OpenfdaContext $ctx): ?string
    {
    ...
    private function _reject(OpenfdaContext $ctx, string $required): void
    {
    ...
    private function _track(OpenfdaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
