...
// Openfda SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class OpenfdaTestFeature extends OpenfdaBaseFeature
{
    ...
    public function init(OpenfdaContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (OpenfdaContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (OpenfdaContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(OpenfdaContext $ctx, $op, $args): array
    {
