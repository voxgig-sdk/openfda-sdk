...
class OpenfdaCacheFeature extends OpenfdaBaseFeature
{
    ...
    private function _through(OpenfdaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
