...
class OpenfdaRatelimitFeature extends OpenfdaBaseFeature
{
    ...
    private function _acquire(OpenfdaContext $ctx): void
    {
    ...
    private function _track(OpenfdaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
