...
// Openfda SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = OpenfdaOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(OpenfdaOmni::structfix($now, Struct::undef()))
                        !== json_encode(OpenfdaOmni::structfix($val, Struct::undef()))) {
