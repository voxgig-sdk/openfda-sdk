...
class OpenfdaTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenfdaTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = OpenfdaTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = OpenfdaTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
