...
|---|---|---|
| `ts/` | @voxgig-sdk/openfda-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/openfda-sdk \
      --repository voxgig-sdk/openfda-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/openfda-sdk` shows it, and
`npm trust revoke @voxgig-sdk/openfda-sdk --id=<id>` removes it.
