...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/openfda` | `npm install @voxgig-sdk/openfda` |
| Python | `voxgig-sdk-openfda` | `pip install voxgig-sdk-openfda` |
| PHP | `voxgig-sdk/openfda` | `composer require voxgig-sdk/openfda` |
| Golang | `github.com/voxgig-sdk/openfda-sdk/go` | `go get github.com/voxgig-sdk/openfda-sdk/go` |
| Ruby | `voxgig-sdk-openfda` | `gem install voxgig-sdk-openfda` |
| Lua | `voxgig-sdk-openfda` | `luarocks install voxgig-sdk-openfda` |
