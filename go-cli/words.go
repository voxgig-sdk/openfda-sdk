...
func registerSDKWords(r *eng.Registry, client *sdk.OpenfdaSDK) {
...
func runOp(client *sdk.OpenfdaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
