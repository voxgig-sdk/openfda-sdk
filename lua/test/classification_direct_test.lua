...
describe("ClassificationDirect", function()
  it("should direct-list-classification", function()
    local setup = classification_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-classification", setup.live and "live" or "unit")
...
function classification_direct_setup(mockres)
