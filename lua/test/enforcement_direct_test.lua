...
describe("EnforcementDirect", function()
  it("should direct-list-enforcement", function()
    local setup = enforcement_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-enforcement", setup.live and "live" or "unit")
...
function enforcement_direct_setup(mockres)
