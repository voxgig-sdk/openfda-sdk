...
describe("ShortageDirect", function()
  it("should direct-list-shortage", function()
    local setup = shortage_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-shortage", setup.live and "live" or "unit")
