...
describe("NsdeDirect", function()
  it("should direct-list-nsde", function()
    local setup = nsde_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-nsde", setup.live and "live" or "unit")
...
function nsde_direct_setup(mockres)
