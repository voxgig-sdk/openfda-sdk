...
describe("NdcDirect", function()
  it("should direct-list-ndc", function()
    local setup = ndc_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-ndc", setup.live and "live" or "unit")
...
function ndc_direct_setup(mockres)
