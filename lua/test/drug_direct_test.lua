...
describe("DrugDirect", function()
  it("should direct-list-drug", function()
    local setup = drug_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-drug", setup.live and "live" or "unit")
...
function drug_direct_setup(mockres)
