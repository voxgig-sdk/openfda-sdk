...
describe("DrugsfdaDirect", function()
  it("should direct-list-drugsfda", function()
    local setup = drugsfda_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-drugsfda", setup.live and "live" or "unit")
...
function drugsfda_direct_setup(mockres)
