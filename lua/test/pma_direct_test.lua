...
describe("PmaDirect", function()
  it("should direct-list-pma", function()
    local setup = pma_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-pma", setup.live and "live" or "unit")
...
function pma_direct_setup(mockres)
