...
describe("SubstanceDirect", function()
  it("should direct-list-substance", function()
    local setup = substance_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-substance", setup.live and "live" or "unit")
...
function substance_direct_setup(mockres)
