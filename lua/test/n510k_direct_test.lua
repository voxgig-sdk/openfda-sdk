...
describe("N510kDirect", function()
  it("should direct-list-n510k", function()
    local setup = n510k_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-n510k", setup.live and "live" or "unit")
...
function n510k_direct_setup(mockres)
