-- Openfda SDK Drugsfda entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local DrugsfdaEntity = {}
DrugsfdaEntity.__index = DrugsfdaEntity


function DrugsfdaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DrugsfdaEntity)
  self._name = "drugsfda"
  self._client = client
...
function DrugsfdaEntity:get_name()
  return self._name
end


function DrugsfdaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DrugsfdaEntity.new(self._client, opts)
end
...
function DrugsfdaEntity:mark_deleted()
  self._deleted = true
end


function DrugsfdaEntity:deleted()
  return true == self._deleted
end


function DrugsfdaEntity:data_set(args)
  if args ~= nil then
...
function DrugsfdaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DrugsfdaEntity:match_set(args)
  if args ~= nil then
...
function DrugsfdaEntity:match_get()
...
function DrugsfdaEntity:stream(action, args, callopts)
...
function DrugsfdaEntity:_run_op(ctx, post_done)
  local utility = self._utility
