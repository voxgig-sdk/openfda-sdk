...
local SubstanceEntity = {}
SubstanceEntity.__index = SubstanceEntity


function SubstanceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubstanceEntity)
  self._name = "substance"
  self._client = client
...
function SubstanceEntity:get_name()
  return self._name
end


function SubstanceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubstanceEntity.new(self._client, opts)
end
...
function SubstanceEntity:mark_deleted()
  self._deleted = true
end


function SubstanceEntity:deleted()
  return true == self._deleted
end


function SubstanceEntity:data_set(args)
  if args ~= nil then
...
function SubstanceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubstanceEntity:match_set(args)
  if args ~= nil then
...
function SubstanceEntity:match_get()
...
function SubstanceEntity:stream(action, args, callopts)
...
function SubstanceEntity:_run_op(ctx, post_done)
  local utility = self._utility
