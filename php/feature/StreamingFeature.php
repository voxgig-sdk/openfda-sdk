...
class OpenfdaStreamingFeature extends OpenfdaBaseFeature
{
    ...
    private function _iterate(OpenfdaResult $result): \Generator
    {
    ...
    private function _streamable(OpenfdaContext $ctx): bool
    {
