...
class OpenfdaProxyFeature extends OpenfdaBaseFeature
{
    ...
    public function init(OpenfdaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OpenfdaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
