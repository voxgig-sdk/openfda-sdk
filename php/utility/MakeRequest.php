...
// Openfda SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class OpenfdaMakeRequest
{
    public static function call(OpenfdaContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new OpenfdaResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new OpenfdaResponse($fetched);
        } else {
