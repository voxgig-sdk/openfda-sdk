...
class OpenfdaGraphql
{
    ...
    // equivalent.
    public static function body(OpenfdaContext $ctx): mixed
    {
    ...
    public static function errors(OpenfdaContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
