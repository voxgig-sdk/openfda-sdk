...
class DrugsfdaDirectTest extends TestCase
{
    public function test_direct_list_drugsfda(): void
    {
        $setup = drugsfda_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-drugsfda", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
