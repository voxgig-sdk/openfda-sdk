...
class ClassificationDirectTest extends TestCase
{
    public function test_direct_list_classification(): void
    {
        $setup = classification_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-classification", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
