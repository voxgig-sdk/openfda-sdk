...
class SubstanceDirectTest extends TestCase
{
    public function test_direct_list_substance(): void
    {
        $setup = substance_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-substance", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
