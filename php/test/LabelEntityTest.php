...
class LabelEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set OPENFDA_TEST_LABEL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function label_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("OPENFDA_TEST_LABEL_ENTID");
