...
class DrugDirectTest extends TestCase
{
    public function test_direct_list_drug(): void
    {
        $setup = drug_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-drug", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
