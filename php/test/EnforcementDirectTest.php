...
class EnforcementDirectTest extends TestCase
{
    public function test_direct_list_enforcement(): void
    {
        $setup = enforcement_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-enforcement", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
