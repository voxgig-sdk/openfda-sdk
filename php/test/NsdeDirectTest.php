...
class NsdeDirectTest extends TestCase
{
    public function test_direct_list_nsde(): void
    {
        $setup = nsde_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-nsde", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
