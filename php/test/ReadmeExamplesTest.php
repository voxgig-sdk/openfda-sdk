...
// Openfda SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OpenfdaSDK::test)
...
{
    private const SDK_CLASS = 'OpenfdaSDK';
    ...
    private const SDK_BASE = 'openfda_sdk';
