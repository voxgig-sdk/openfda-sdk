...
class OpenfdaTestRunner
{
    ...
    {
        $live = self::getenv('OPENFDA_TEST_LIVE');
        $override = self::getenv('OPENFDA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('OPENFDA_TEST_EXPLAIN');
...
class_alias('OpenfdaTestRunner', 'Runner');
class_alias('OpenfdaHelpers', 'Helpers');
