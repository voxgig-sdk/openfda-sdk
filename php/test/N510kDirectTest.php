...
class N510kDirectTest extends TestCase
{
    public function test_direct_list_n510k(): void
    {
        $setup = n510k_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-n510k", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
