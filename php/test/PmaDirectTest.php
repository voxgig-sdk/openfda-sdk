...
class PmaDirectTest extends TestCase
{
    public function test_direct_list_pma(): void
    {
        $setup = pma_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-pma", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
