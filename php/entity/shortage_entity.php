...
class ShortageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ShortageEntity($this->_client, $opts);
    }

    /**
     * @param Shortage|array $args Shortage data (assoc-array) to store.
     */
    ...
    /**
     * @return Shortage|array The current Shortage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Shortage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Shortage fields).
     */
     ...
     *
     * @param ShortageListMatch|array|null $reqmatch Match filter (any subset
     *   of Shortage fields) as an assoc-array; ShortageListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Shortage[]|array A list of Shortage items as assoc-arrays at
