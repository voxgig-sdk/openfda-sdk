...
class ClassificationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ClassificationEntity($this->_client, $opts);
    }

    /**
     * @param Classification|array $args Classification data (assoc-array) to store.
     */
    ...
    /**
     * @return Classification|array The current Classification data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Classification fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Classification fields).
     */
    ...
    /**
     * List Classification items matching the given filter.
     *
     * @param ClassificationListMatch|array|null $reqmatch Match filter (any subset
     *   of Classification fields) as an assoc-array; ClassificationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Classification[]|array A list of Classification items as assoc-arrays at
