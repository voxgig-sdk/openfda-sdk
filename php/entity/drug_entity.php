...
class DrugEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DrugEntity($this->_client, $opts);
    }

    /**
     * @param Drug|array $args Drug data (assoc-array) to store.
     */
    ...
    /**
     * @return Drug|array The current Drug data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Drug fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Drug fields).
     */
     ...
     *
     * @param DrugListMatch|array|null $reqmatch Match filter (any subset
     *   of Drug fields) as an assoc-array; DrugListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Drug[]|array A list of Drug items as assoc-arrays at
