...
class PmaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PmaEntity($this->_client, $opts);
    }

    /**
     * @param Pma|array $args Pma data (assoc-array) to store.
     */
    ...
    /**
     * @return Pma|array The current Pma data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Pma fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Pma fields).
     */
    ...
    /**
     * List Pma items matching the given filter.
     *
     * @param PmaListMatch|array|null $reqmatch Match filter (any subset
     *   of Pma fields) as an assoc-array; PmaListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Pma[]|array A list of Pma items as assoc-arrays at
