...
class NsdeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NsdeEntity($this->_client, $opts);
    }

    /**
     * @param Nsde|array $args Nsde data (assoc-array) to store.
     */
    ...
    /**
     * @return Nsde|array The current Nsde data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Nsde fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Nsde fields).
     */
    ...
    /**
     * List Nsde items matching the given filter.
     *
     * @param NsdeListMatch|array|null $reqmatch Match filter (any subset
     *   of Nsde fields) as an assoc-array; NsdeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Nsde[]|array A list of Nsde items as assoc-arrays at
