...
class SubstanceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SubstanceEntity($this->_client, $opts);
    }

    /**
     * @param Substance|array $args Substance data (assoc-array) to store.
     */
    ...
    /**
     * @return Substance|array The current Substance data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Substance fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Substance fields).
     */
    ...
    /**
     * List Substance items matching the given filter.
     *
     * @param SubstanceListMatch|array|null $reqmatch Match filter (any subset
     *   of Substance fields) as an assoc-array; SubstanceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Substance[]|array A list of Substance items as assoc-arrays at
