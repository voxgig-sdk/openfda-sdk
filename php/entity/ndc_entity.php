...
class NdcEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NdcEntity($this->_client, $opts);
    }

    /**
     * @param Ndc|array $args Ndc data (assoc-array) to store.
     */
    ...
    /**
     * @return Ndc|array The current Ndc data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Ndc fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Ndc fields).
     */
     ...
     *
     * @param NdcListMatch|array|null $reqmatch Match filter (any subset
     *   of Ndc fields) as an assoc-array; NdcListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ndc[]|array A list of Ndc items as assoc-arrays at
