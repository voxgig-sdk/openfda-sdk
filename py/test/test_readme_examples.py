# Openfda SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OpenfdaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OpenfdaSDK(...) and OpenfdaSDK.test(...) become
#      OpenfdaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "openfda_sdk"
_SDK_CLASS = "OpenfdaSDK"
