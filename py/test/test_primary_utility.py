...
from openfda_sdk.core.result import OpenfdaResult
from openfda_sdk.core.response import OpenfdaResponse
from openfda_sdk.core.operation import OpenfdaOperation
from openfda_sdk.core.error import OpenfdaError
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = OpenfdaSDK.test(None, None)
        ...
        class TestInitFeature(OpenfdaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(OpenfdaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = OpenfdaSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = OpenfdaSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = OpenfdaSDK.test(None, setup_opts)
