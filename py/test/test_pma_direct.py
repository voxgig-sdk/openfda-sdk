...
class TestPmaDirect:
    ...
    def test_should_direct_list_pma(self):
        setup = _pma_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-pma", "live" if setup["live"] else "unit")
        if _skip:
