# Openfda SDK utility: make_error
...
def make_error_util(ctx, err):
    if ctx is None:
        from openfda_sdk.core.context import OpenfdaContext
        ctx = OpenfdaContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, OpenfdaError):
        errmsg = err.msg
