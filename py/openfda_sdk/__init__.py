...
from openfda_sdk.core.spec import OpenfdaSpec
from openfda_sdk.core import helpers

# Load utility registration (populates Utility._registrar)
from openfda_sdk.utility import register

# Load features
from openfda_sdk.feature.base_feature import OpenfdaBaseFeature
from openfda_sdk.features import _has_feature, _make_feature
...
class OpenfdaSDK:
    ...
    def __init__(self, options=None):
        ...
        from openfda_sdk.config import shared_config
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "OpenfdaSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OpenfdaSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Classification(self, data=None) -> "ClassificationEntity":
        ...
        from openfda_sdk.entity.classification_entity import ClassificationEntity
    ...
    def Drug(self, data=None) -> "DrugEntity":
        ...
        from openfda_sdk.entity.drug_entity import DrugEntity
    ...
    def Drugsfda(self, data=None) -> "DrugsfdaEntity":
        ...
        from openfda_sdk.entity.drugsfda_entity import DrugsfdaEntity
    ...
    def Enforcement(self, data=None) -> "EnforcementEntity":
        ...
        from openfda_sdk.entity.enforcement_entity import EnforcementEntity
    ...
    def Problem(self, data=None) -> "ProblemEntity":
        ...
        from openfda_sdk.entity.problem_entity import ProblemEntity
    ...
    def Shortage(self, data=None) -> "ShortageEntity":
        ...
        from openfda_sdk.entity.shortage_entity import ShortageEntity
    ...
    def Substance(self, data=None) -> "SubstanceEntity":
        ...
        from openfda_sdk.entity.substance_entity import SubstanceEntity
