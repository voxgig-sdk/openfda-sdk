...
from openfda_sdk.core.control import OpenfdaControl
...
from openfda_sdk.core.helpers import get_ctx_prop, to_map
...
class OpenfdaContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, OpenfdaResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return OpenfdaError(code, msg, self)
