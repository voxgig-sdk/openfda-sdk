...
class ClassificationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ClassificationEntity(self._client, opts)
    ...
    def data_get(self) -> Classification:
    ...
    def match_get(self) -> Classification:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Classification]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Classification().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
