...
class ShortageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ShortageEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Shortage]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Shortage().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
