...
class N510kEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return N510kEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[N510k]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.N510k().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
