...
## Install
```bash
go get github.com/voxgig-sdk/openfda-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/openfda-sdk=../path/to/github.com/voxgig-sdk/openfda-sdk
```
...
```
github.com/voxgig-sdk/openfda-sdk/
...
The root package (`github.com/voxgig-sdk/openfda-sdk`) re-exports everything needed
