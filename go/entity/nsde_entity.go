...
func NewNsdeEntity(client *core.OpenfdaSDK, entopts map[string]any) *NsdeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NsdeEntity) GetName() string { return e.name }
...
func (e *NsdeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NsdeEntity) Deleted() bool {
	return e.deleted
}


func (e *NsdeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNsdeEntity(e.client, opts)
}

func (e *NsdeEntity) Data(args ...any) any {
...
func (e *NsdeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Nsde; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NsdeEntity) DataTyped(data ...Nsde) Nsde {
	if len(data) > 0 {
		return typedFrom[Nsde](e.Data(asMap(data[0])))
	}
	return typedFrom[Nsde](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Nsde (all fields
// optional at the wire level).
func (e *NsdeEntity) MatchTyped(match ...Nsde) Nsde {
	if len(match) > 0 {
		return typedFrom[Nsde](e.Match(asMap(match[0])))
	}
	return typedFrom[Nsde](e.Match())
}
...
func (e *NsdeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NsdeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *NsdeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NsdeListMatch and returns []Nsde. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *NsdeEntity) ListTyped(reqmatch NsdeListMatch, ctrl map[string]any) ([]Nsde, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Nsde](res), nil
}



func (e *NsdeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NsdeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NsdeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NsdeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
