...
func NewPmaEntity(client *core.OpenfdaSDK, entopts map[string]any) *PmaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PmaEntity) GetName() string { return e.name }
...
func (e *PmaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PmaEntity) Deleted() bool {
	return e.deleted
}


func (e *PmaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPmaEntity(e.client, opts)
}

func (e *PmaEntity) Data(args ...any) any {
...
func (e *PmaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Pma; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PmaEntity) DataTyped(data ...Pma) Pma {
	if len(data) > 0 {
		return typedFrom[Pma](e.Data(asMap(data[0])))
	}
	return typedFrom[Pma](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Pma (all fields
// optional at the wire level).
func (e *PmaEntity) MatchTyped(match ...Pma) Pma {
	if len(match) > 0 {
		return typedFrom[Pma](e.Match(asMap(match[0])))
	}
	return typedFrom[Pma](e.Match())
}
...
func (e *PmaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PmaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PmaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PmaListMatch and returns []Pma. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PmaEntity) ListTyped(reqmatch PmaListMatch, ctrl map[string]any) ([]Pma, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Pma](res), nil
}



func (e *PmaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PmaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PmaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PmaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
