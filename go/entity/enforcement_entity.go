...
func NewEnforcementEntity(client *core.OpenfdaSDK, entopts map[string]any) *EnforcementEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EnforcementEntity) GetName() string { return e.name }
...
func (e *EnforcementEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EnforcementEntity) Deleted() bool {
	return e.deleted
}


func (e *EnforcementEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEnforcementEntity(e.client, opts)
}

func (e *EnforcementEntity) Data(args ...any) any {
...
func (e *EnforcementEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Enforcement; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EnforcementEntity) DataTyped(data ...Enforcement) Enforcement {
	if len(data) > 0 {
		return typedFrom[Enforcement](e.Data(asMap(data[0])))
	}
	return typedFrom[Enforcement](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Enforcement (all fields
// optional at the wire level).
func (e *EnforcementEntity) MatchTyped(match ...Enforcement) Enforcement {
	if len(match) > 0 {
		return typedFrom[Enforcement](e.Match(asMap(match[0])))
	}
	return typedFrom[Enforcement](e.Match())
}
...
func (e *EnforcementEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EnforcementEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *EnforcementEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EnforcementListMatch and returns []Enforcement. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EnforcementEntity) ListTyped(reqmatch EnforcementListMatch, ctrl map[string]any) ([]Enforcement, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Enforcement](res), nil
}



func (e *EnforcementEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EnforcementEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EnforcementEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EnforcementEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
