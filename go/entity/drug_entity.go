...
func NewDrugEntity(client *core.OpenfdaSDK, entopts map[string]any) *DrugEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DrugEntity) GetName() string { return e.name }
...
func (e *DrugEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DrugEntity) Deleted() bool {
	return e.deleted
}


func (e *DrugEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDrugEntity(e.client, opts)
}

func (e *DrugEntity) Data(args ...any) any {
...
func (e *DrugEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Drug; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DrugEntity) DataTyped(data ...Drug) Drug {
	if len(data) > 0 {
		return typedFrom[Drug](e.Data(asMap(data[0])))
	}
	return typedFrom[Drug](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Drug (all fields
// optional at the wire level).
func (e *DrugEntity) MatchTyped(match ...Drug) Drug {
	if len(match) > 0 {
		return typedFrom[Drug](e.Match(asMap(match[0])))
	}
	return typedFrom[Drug](e.Match())
}
...
func (e *DrugEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DrugEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DrugEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DrugListMatch and returns []Drug. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DrugEntity) ListTyped(reqmatch DrugListMatch, ctrl map[string]any) ([]Drug, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Drug](res), nil
}



func (e *DrugEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DrugEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DrugEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DrugEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
