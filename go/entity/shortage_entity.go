...
func NewShortageEntity(client *core.OpenfdaSDK, entopts map[string]any) *ShortageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ShortageEntity) GetName() string { return e.name }
...
func (e *ShortageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ShortageEntity) Deleted() bool {
	return e.deleted
}


func (e *ShortageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewShortageEntity(e.client, opts)
}

func (e *ShortageEntity) Data(args ...any) any {
...
func (e *ShortageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Shortage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ShortageEntity) DataTyped(data ...Shortage) Shortage {
	if len(data) > 0 {
		return typedFrom[Shortage](e.Data(asMap(data[0])))
	}
	return typedFrom[Shortage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Shortage (all fields
// optional at the wire level).
func (e *ShortageEntity) MatchTyped(match ...Shortage) Shortage {
	if len(match) > 0 {
		return typedFrom[Shortage](e.Match(asMap(match[0])))
	}
	return typedFrom[Shortage](e.Match())
}
...
func (e *ShortageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ShortageEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ShortageEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ShortageListMatch and returns []Shortage. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ShortageEntity) ListTyped(reqmatch ShortageListMatch, ctrl map[string]any) ([]Shortage, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Shortage](res), nil
}



func (e *ShortageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ShortageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ShortageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ShortageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
