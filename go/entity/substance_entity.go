...
func NewSubstanceEntity(client *core.OpenfdaSDK, entopts map[string]any) *SubstanceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SubstanceEntity) GetName() string { return e.name }
...
func (e *SubstanceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SubstanceEntity) Deleted() bool {
	return e.deleted
}


func (e *SubstanceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSubstanceEntity(e.client, opts)
}

func (e *SubstanceEntity) Data(args ...any) any {
...
func (e *SubstanceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Substance; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SubstanceEntity) DataTyped(data ...Substance) Substance {
	if len(data) > 0 {
		return typedFrom[Substance](e.Data(asMap(data[0])))
	}
	return typedFrom[Substance](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Substance (all fields
// optional at the wire level).
func (e *SubstanceEntity) MatchTyped(match ...Substance) Substance {
	if len(match) > 0 {
		return typedFrom[Substance](e.Match(asMap(match[0])))
	}
	return typedFrom[Substance](e.Match())
}
...
func (e *SubstanceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SubstanceEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SubstanceEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SubstanceListMatch and returns []Substance. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SubstanceEntity) ListTyped(reqmatch SubstanceListMatch, ctrl map[string]any) ([]Substance, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Substance](res), nil
}



func (e *SubstanceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SubstanceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SubstanceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SubstanceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
