...
func NewNdcEntity(client *core.OpenfdaSDK, entopts map[string]any) *NdcEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NdcEntity) GetName() string { return e.name }
...
func (e *NdcEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NdcEntity) Deleted() bool {
	return e.deleted
}


func (e *NdcEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNdcEntity(e.client, opts)
}

func (e *NdcEntity) Data(args ...any) any {
...
func (e *NdcEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *NdcEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NdcEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *NdcEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NdcEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NdcEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NdcEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
