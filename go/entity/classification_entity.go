...
func NewClassificationEntity(client *core.OpenfdaSDK, entopts map[string]any) *ClassificationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ClassificationEntity) GetName() string { return e.name }
...
func (e *ClassificationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ClassificationEntity) Deleted() bool {
	return e.deleted
}


func (e *ClassificationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewClassificationEntity(e.client, opts)
}

func (e *ClassificationEntity) Data(args ...any) any {
...
func (e *ClassificationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Classification; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ClassificationEntity) DataTyped(data ...Classification) Classification {
	if len(data) > 0 {
		return typedFrom[Classification](e.Data(asMap(data[0])))
	}
	return typedFrom[Classification](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Classification (all fields
// optional at the wire level).
func (e *ClassificationEntity) MatchTyped(match ...Classification) Classification {
	if len(match) > 0 {
		return typedFrom[Classification](e.Match(asMap(match[0])))
	}
	return typedFrom[Classification](e.Match())
}
...
func (e *ClassificationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ClassificationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ClassificationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ClassificationListMatch and returns []Classification. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ClassificationEntity) ListTyped(reqmatch ClassificationListMatch, ctrl map[string]any) ([]Classification, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Classification](res), nil
}



func (e *ClassificationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ClassificationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ClassificationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ClassificationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
