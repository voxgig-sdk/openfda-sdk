...
func NewDrugsfdaEntity(client *core.OpenfdaSDK, entopts map[string]any) *DrugsfdaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DrugsfdaEntity) GetName() string { return e.name }
...
func (e *DrugsfdaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DrugsfdaEntity) Deleted() bool {
	return e.deleted
}


func (e *DrugsfdaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDrugsfdaEntity(e.client, opts)
}

func (e *DrugsfdaEntity) Data(args ...any) any {
...
func (e *DrugsfdaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Drugsfda; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DrugsfdaEntity) DataTyped(data ...Drugsfda) Drugsfda {
	if len(data) > 0 {
		return typedFrom[Drugsfda](e.Data(asMap(data[0])))
	}
	return typedFrom[Drugsfda](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Drugsfda (all fields
// optional at the wire level).
func (e *DrugsfdaEntity) MatchTyped(match ...Drugsfda) Drugsfda {
	if len(match) > 0 {
		return typedFrom[Drugsfda](e.Match(asMap(match[0])))
	}
	return typedFrom[Drugsfda](e.Match())
}
...
func (e *DrugsfdaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DrugsfdaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DrugsfdaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DrugsfdaListMatch and returns []Drugsfda. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DrugsfdaEntity) ListTyped(reqmatch DrugsfdaListMatch, ctrl map[string]any) ([]Drugsfda, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Drugsfda](res), nil
}



func (e *DrugsfdaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DrugsfdaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DrugsfdaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DrugsfdaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
