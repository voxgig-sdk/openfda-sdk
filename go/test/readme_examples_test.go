...
const testSeed = `map[string]any{"entity": map[string]any{"classification": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "drug": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "drugsfda": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "enforcement": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "label": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "n510k": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ndc": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "nsde": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pma": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "problem": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "shortage": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "substance": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
