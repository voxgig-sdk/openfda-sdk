...
func (sdk *OpenfdaSDK) OptionsMap() map[string]any {
...
func (sdk *OpenfdaSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *OpenfdaSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *OpenfdaSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenfdaSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *OpenfdaSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *OpenfdaSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("OpenfdaSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *OpenfdaSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenfdaSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("OpenfdaSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
