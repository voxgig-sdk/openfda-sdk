...
class DrugsfdaEntity
  ...
  def make
    opts = @_entopts.dup
    DrugsfdaEntity.new(@_client, opts)
  end
  ...
  # @return [Drugsfda, Hash] the current Drugsfda data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Drugsfda fields)
  def match_get
  ...
  #
  # @param reqmatch [DrugsfdaListMatch, Hash, nil] match filter (any subset of
  #   Drugsfda fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Drugsfda>, Array] the matching Drugsfda items; raises OpenfdaError on failure
