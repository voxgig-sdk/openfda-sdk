...
class ProblemEntity
  ...
  def make
    opts = @_entopts.dup
    ProblemEntity.new(@_client, opts)
  end
  ...
  # @return [Problem, Hash] the current Problem data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Problem fields)
  def match_get
  ...
  #
  # @param reqmatch [ProblemListMatch, Hash, nil] match filter (any subset of
  #   Problem fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Problem>, Array] the matching Problem items; raises OpenfdaError on failure
