...
class DrugEntity
  ...
  #
  # @param reqmatch [DrugListMatch, Hash, nil] match filter (any subset of
  #   Drug fields); defaults to nil, treated as an empty match that lists all.
