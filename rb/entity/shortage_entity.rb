...
class ShortageEntity
  ...
  def make
    opts = @_entopts.dup
    ShortageEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [ShortageListMatch, Hash, nil] match filter (any subset of
  #   Shortage fields); defaults to nil, treated as an empty match that lists all.
