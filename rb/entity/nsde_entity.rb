...
class NsdeEntity
  ...
  # @return [Nsde, Hash] the current Nsde data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Nsde fields)
  def match_get
  ...
  #
  # @param reqmatch [NsdeListMatch, Hash, nil] match filter (any subset of
  #   Nsde fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Nsde>, Array] the matching Nsde items; raises OpenfdaError on failure
