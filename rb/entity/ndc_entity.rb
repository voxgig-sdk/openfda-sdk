...
class NdcEntity
  ...
  #
  # @param reqmatch [NdcListMatch, Hash, nil] match filter (any subset of
  #   Ndc fields); defaults to nil, treated as an empty match that lists all.
