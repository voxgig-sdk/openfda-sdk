...
class PmaEntity
  ...
  # @return [Pma, Hash] the current Pma data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Pma fields)
  def match_get
  ...
  #
  # @param reqmatch [PmaListMatch, Hash, nil] match filter (any subset of
  #   Pma fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Pma>, Array] the matching Pma items; raises OpenfdaError on failure
