...
class EnforcementEntity
  ...
  def make
    opts = @_entopts.dup
    EnforcementEntity.new(@_client, opts)
  end
  ...
  # @return [Enforcement, Hash] the current Enforcement data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Enforcement fields)
  def match_get
  ...
  #
  # @param reqmatch [EnforcementListMatch, Hash, nil] match filter (any subset of
  #   Enforcement fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Enforcement>, Array] the matching Enforcement items; raises OpenfdaError on failure
