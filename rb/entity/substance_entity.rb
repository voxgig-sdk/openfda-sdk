...
class SubstanceEntity
  ...
  def make
    opts = @_entopts.dup
    SubstanceEntity.new(@_client, opts)
  end
  ...
  # @return [Substance, Hash] the current Substance data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Substance fields)
  def match_get
  ...
  #
  # @param reqmatch [SubstanceListMatch, Hash, nil] match filter (any subset of
  #   Substance fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Substance>, Array] the matching Substance items; raises OpenfdaError on failure
