...
module OpenfdaTestRunner
  ...
  def self.env_override(m)
    live = getenv("OPENFDA_TEST_LIVE")
    override = getenv("OPENFDA_TEST_OVERRIDE")
    ...
    explain = getenv("OPENFDA_TEST_EXPLAIN")
    m["OPENFDA_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = OpenfdaTestRunner
Helpers = OpenfdaHelpers
Vs = VoxgigStruct
