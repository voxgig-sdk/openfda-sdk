...
(0, node_test_1.describe)('NdcEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/ndc/NdcTestData.json');
    ...
    let idmap = transform(['ndc01', 'ndc02', 'ndc03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const env = (0, utility_1.envOverride)({
        'OPENFDA_TEST_NDC_ENTID': idmap,
        'OPENFDA_TEST_LIVE': 'FALSE',
        'OPENFDA_TEST_EXPLAIN': 'FALSE',
        'OPENFDA_APIKEY': '',
    });
    idmap = env['OPENFDA_TEST_NDC_ENTID'];
    const live = 'TRUE' === env.OPENFDA_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['OPENFDA_TEST_NDC_ENTID'];
...
//# sourceMappingURL=NdcEntity.test.js.map