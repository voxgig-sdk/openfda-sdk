...
(0, node_test_1.describe)('NsdeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-nsde', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-nsde', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OPENFDA_TEST_NSDE_ENTID'];
...
//# sourceMappingURL=NsdeDirect.test.js.map