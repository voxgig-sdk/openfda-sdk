...
(0, node_test_1.describe)('SubstanceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-substance', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-substance', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OPENFDA_TEST_SUBSTANCE_ENTID'];
...
//# sourceMappingURL=SubstanceDirect.test.js.map