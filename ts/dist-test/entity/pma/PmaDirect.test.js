...
(0, node_test_1.describe)('PmaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-pma', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-pma', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OPENFDA_TEST_PMA_ENTID'];
...
//# sourceMappingURL=PmaDirect.test.js.map