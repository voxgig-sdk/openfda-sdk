...
(0, node_test_1.describe)('ShortageEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/shortage/ShortageTestData.json');
    ...
    let idmap = transform(['shortage01', 'shortage02', 'shortage03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const env = (0, utility_1.envOverride)({
        'OPENFDA_TEST_SHORTAGE_ENTID': idmap,
        'OPENFDA_TEST_LIVE': 'FALSE',
        'OPENFDA_TEST_EXPLAIN': 'FALSE',
        'OPENFDA_APIKEY': '',
    });
    idmap = env['OPENFDA_TEST_SHORTAGE_ENTID'];
    const live = 'TRUE' === env.OPENFDA_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['OPENFDA_TEST_SHORTAGE_ENTID'];
...
//# sourceMappingURL=ShortageEntity.test.js.map