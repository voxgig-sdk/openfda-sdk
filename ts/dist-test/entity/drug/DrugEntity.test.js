...
(0, node_test_1.describe)('DrugEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'drug.' + op, live))
                return;
        }
        ...
        let drug_ref01_data = Object.values(setup.data.existing.drug)[0];
        // LIST
        const drug_ref01_ent = client.Drug();
        const drug_ref01_match = {};
        const drug_ref01_list = (await drug_ref01_ent.list(drug_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/drug/DrugTestData.json');
    ...
    let idmap = transform(['drug01', 'drug02', 'drug03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DrugEntity.test.js.map