...
(0, node_test_1.describe)('DrugDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-drug', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-drug', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OPENFDA_TEST_DRUG_ENTID'];
...
//# sourceMappingURL=DrugDirect.test.js.map