...
(0, node_test_1.describe)('N510kDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-n510k', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-n510k', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OPENFDA_TEST_N510K_ENTID'];
...
//# sourceMappingURL=N510kDirect.test.js.map