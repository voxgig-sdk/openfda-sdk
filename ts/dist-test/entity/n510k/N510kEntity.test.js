...
(0, node_test_1.describe)('N510kEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/n510k/N510kTestData.json');
    ...
    let idmap = transform(['n510k01', 'n510k02', 'n510k03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    if (live) {
        const rawIds = process.env['OPENFDA_TEST_N510K_ENTID'];
...
//# sourceMappingURL=N510kEntity.test.js.map