...
(0, node_test_1.describe)('DrugsfdaEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/drugsfda/DrugsfdaTestData.json');
    ...
    let idmap = transform(['drugsfda01', 'drugsfda02', 'drugsfda03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['OPENFDA_TEST_DRUGSFDA_ENTID'];
    const live = 'TRUE' === env.OPENFDA_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['OPENFDA_TEST_DRUGSFDA_ENTID'];
...
//# sourceMappingURL=DrugsfdaEntity.test.js.map