...
(0, node_test_1.describe)('ClassificationEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/classification/ClassificationTestData.json');
    ...
    let idmap = transform(['classification01', 'classification02', 'classification03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['OPENFDA_TEST_CLASSIFICATION_ENTID'];
    const live = 'TRUE' === env.OPENFDA_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['OPENFDA_TEST_CLASSIFICATION_ENTID'];
...
//# sourceMappingURL=ClassificationEntity.test.js.map