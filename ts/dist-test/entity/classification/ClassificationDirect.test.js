...
(0, node_test_1.describe)('ClassificationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-classification', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-classification', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.OPENFDA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.OpenfdaSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.OPENFDA_APIKEY,
        }));
        let idmap = env['OPENFDA_TEST_CLASSIFICATION_ENTID'];
    ...
    const client = new __1.OpenfdaSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ClassificationDirect.test.js.map