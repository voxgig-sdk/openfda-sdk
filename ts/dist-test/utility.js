...
function envOverride(m) {
    if ('TRUE' === process.env.OPENFDA_TEST_LIVE ||
        'TRUE' === process.env.OPENFDA_TEST_OVERRIDE) {
    ...
    m.OPENFDA_TEST_EXPLAIN = process.env.OPENFDA_TEST_EXPLAIN || m.OPENFDA_TEST_EXPLAIN;
    return m;
}
