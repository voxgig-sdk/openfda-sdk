...
describe('DrugsfdaEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (!live && maybeSkipControl(t, 'entityOp', 'drugsfda.' + op, live)) return
    }
    ...
    let drugsfda_ref01_data = Object.values(setup.data.existing.drugsfda)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/drugsfda/DrugsfdaTestData.json')
