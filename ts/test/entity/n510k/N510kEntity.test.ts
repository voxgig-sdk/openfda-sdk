...
describe('N510kEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (!live && maybeSkipControl(t, 'entityOp', 'n510k.' + op, live)) return
    }
    ...
    let n510k_ref01_data = Object.values(setup.data.existing.n510k)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/n510k/N510kTestData.json')
