...
//     (\`new OpenfdaSDK(...)\` / \`OpenfdaSDK.test(...)\` become
//     \`OpenfdaSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"classification":{"test01":{"id":"test01"}},"drug":{"test01":{"id":"test01"}},"drugsfda":{"test01":{"id":"test01"}},"enforcement":{"test01":{"id":"test01"}},"event":{"test01":{"id":"test01"}},"label":{"test01":{"id":"test01"}},"n510k":{"test01":{"id":"test01"}},"ndc":{"test01":{"id":"test01"}},"nsde":{"test01":{"id":"test01"}},"pma":{"test01":{"id":"test01"}},"problem":{"test01":{"id":"test01"}},"shortage":{"test01":{"id":"test01"}},"substance":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new OpenfdaSDK(...)\` and any
// \`OpenfdaSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+OpenfdaSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/OpenfdaSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
