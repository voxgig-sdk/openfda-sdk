...
exports.OpenfdaEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends OpenfdaEntityBase<Advice>`.
class OpenfdaEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.OpenfdaEntityBase = OpenfdaEntityBase;
//# sourceMappingURL=OpenfdaEntityBase.js.map